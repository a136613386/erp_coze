...
export async function searchCustomers(keyword: string): Promise<CustomerListItem[]> {
  ...
  return customers.filter((customer) =>
    customer.name.includes(normalizedKeyword) ||
    customer.company.includes(normalizedKeyword) ||
